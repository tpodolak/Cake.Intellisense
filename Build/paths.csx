...
public class BuildPaths
{
    ...
    {
        context.Information("Building paths");
    ...
    public static BuildDirectories GetBuildDirectories(ICakeContext context, BuildVersion version)
    {
        ...
        var artifacts = rootDir.Combine(".artifacts").Combine(version.SemVersion);
        ...
        return new BuildDirectories(rootDir, artifacts ,testDirs, toClean);
    }
}
...
public class BuildFiles
{
    ...
    public BuildFiles(FilePath solution, FilePath cakeIntellisenseNuSpec, ICollection<FilePath> testAssemblies)
    {
        Solution = solution;
